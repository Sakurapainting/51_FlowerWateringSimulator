 ...
 * 
 * ⏰ 时间参数：
 * - 开始小时：0-23 (24小时制) - 显示标识"c"
 * - 开始分钟：0-59 - 显示标识"B"
 * - 开始秒：  0-59 - 显示标识"A"
 * 
 * 💧 流量参数：
 * - 浇水毫升数：50-9999毫升 - 显示标识"d"
 * - 调节步长：50毫升
 * - 建议范围：100-500毫升
 * 
 * 📊 显示格式：
 * - 秒设置：   000000SA（S为秒值，"A"标识）
 * - 分钟设置： 000000MB（M为分钟值，"B"标识）
 * - 小时设置： 000000Hc（H为小时值，"c"标识）
 * - 毫升设置： XXXXXXXd（前7位毫升数，"d"标识）
 * - 剩余显示： XXXXXXXd（前7位剩余毫升数，"d"标识）
 */
